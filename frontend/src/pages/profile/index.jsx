...
function ProfilePage() {
    ...
    const updatedProfilePicture = async (file) => {
                ...
                {authState.user && userProfile.userId &&
                    <div className={styles.container}>
                        <div className={styles.backDropContainer}>
                            ...
                            <input onChange={(e) => updatedProfilePicture(e.target.files[0])} type='file' id='profilePictureUpload' className={styles.hiddenInput} />
                        ...
                        <div className={styles.profileContainer__details}>
                            ...
                            <div style={{ display: "flex", gap: "0.7rem" }}>
                                ...
                                <div style={{ flex: "0.8" }}>
                                    ...
                                    <div>
                                        <textarea value={userProfile.data}
                                            onChange={(e) => {
